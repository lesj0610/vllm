...
from .gpu.warmup import warmup_kernels, warmup_v1_kernels
...
class Worker(WorkerBase):
    ...
    def compile_or_warm_up_model(self) -> CompilationTimes:
        ...
        if self.use_v2_model_runner:
            ...
            # V1: Run a small real execute_model + sample_tokens path before the
            # JIT monitor is enabled. The legacy _dummy_run path does not cover
            # all input preparation/backend kernels used by real requests.
            warmup_v1_kernels(self.model_runner, self.execute_model, self.sample_tokens)
