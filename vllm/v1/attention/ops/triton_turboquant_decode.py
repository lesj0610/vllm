...
Supports FP8 (E4M3) keys and 3-bit/4-bit values. Non-FP8-key presets
store values with the same rotated Lloyd-Max path as keys; FP8-key mode
keeps the legacy uniform value layout.
"""
