...
class KVCacheManager:
    ...
    def _cacheable_block_pool(self) -> CacheableBlockPoolProtocol:
        ...
        Multi-pool request-constant configs are fail-closed for prefix-cache
        paths before these APIs are used. This cast documents the legacy API
        assumption for mypy without changing runtime dispatch.
        """
    ...
    def can_fit_full_sequence(
        ...
        return self._has_enough_free_blocks_by_pool(num_blocks_to_allocate_by_pool)
