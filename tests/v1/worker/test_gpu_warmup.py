...
def test_v1_attention_warmup_uses_forced_attention_dummy_runs(monkeypatch) -> None:
    monkeypatch.setattr(
...
def test_v1_attention_warmup_skips_without_attention_groups(monkeypatch) -> None:
    monkeypatch.setattr(
        gpu_warmup.torch.accelerator,
        "synchronize",
        lambda: None,
