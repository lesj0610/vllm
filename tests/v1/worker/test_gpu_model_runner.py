...
def test_reshape_token_proportional_attention_unchanged():
    ...
    assert kv_cache.numel() == spec.real_page_size_bytes * num_blocks // dtype_size
    assert kv_cache.stride()[1] == spec.page_size_bytes // dtype_size
