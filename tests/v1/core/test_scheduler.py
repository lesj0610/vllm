...
def test_routed_experts_capacity_uses_token_proportional_pool():
    ...
    model_config.hf_text_config.num_experts = 8
    ...
    assert scheduler.routed_experts_mgr.block_size == block_size
    assert scheduler.routed_experts_mgr.routed_experts_by_slot.shape == (
